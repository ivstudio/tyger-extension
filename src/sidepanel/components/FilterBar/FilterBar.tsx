...
export default function FilterBar() {
    ...
    const { hasActive: hasActiveFilters, count: activeFilterCount } =
                    ...
                    <PopoverContent align="start" className="w-56 p-3">
                        <div className="space-y-2">
                            ...
                            {severityOptions.map(option => (
                                <label
                                    key={option.value}
                                    className="flex cursor-pointer items-center space-x-2 rounded p-1 hover:bg-accent"
                                >
                                    <Checkbox
                                        checked={filters.severity.includes(
                                            option.value
                                        )}
                                        onCheckedChange={() =>
                                            toggleSeverityFilter(option.value)
                                        }
                                    />
                    ...
                    <PopoverContent align="start" className="w-48 p-3">
                        <div className="space-y-2">
                            ...
                            {wcagOptions.map(option => (
                                ...
                                >
                                    <Checkbox
                                        checked={filters.wcag.includes(
                                            option.value
                                        )}
                                        onCheckedChange={() =>
                                            toggleWcagFilter(option.value)
                                        }
                                    />
